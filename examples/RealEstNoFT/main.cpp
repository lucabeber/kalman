...
#include "SystemModelEuleroNoFT.hpp"
...
using namespace KalmanExperimentsNoFT;
...
{   
    ...
    // System
    SystemModel sys(0.002, 0.14e-3, 1000e-3, 2*sqrt(1000)*1e-3);
    ...
    //     // force += noise(generator);
        ...
        std::cout   << -0.2570 - data[i-1][0] << "," << data[i][1] << "," << data[i][2] << "," << vel.v() 
