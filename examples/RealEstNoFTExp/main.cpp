...
#include "SystemModelEuleroFT.hpp"
...
using namespace KalmanExperimentsFT;
...
{   
    ...
    // System
    SystemModel sys(0.002, 0.6,1000.0,2*sqrt(1000.0));
    ...
    //     // force += noise(generator);
        ...
        std::cout   << data[i][0] << "," << data[i][1] << "," << vel.p() << "," << vel.v() 
