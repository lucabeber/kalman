...
if __name__ == "__main__":
    ...
    for line in lines:
        ...
        line_data = np.array([float(s) for s in line_string.split(",")]).reshape((42, 1))
        if data is None:
            data = line_data
        else:
    ...
    np.savetxt("/home/luca/Dottorato/TIM/experiments/trasl_4mms.csv", data, delimiter=",")
    np.savetxt("/home/luca/Dottorato/TIM/experiments/trasl_4mms.txt", data, delimiter=",")
